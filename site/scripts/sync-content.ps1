...
$files = @(
  ...
  @{ src = 'modules\02-prompt-to-pr.md'; dest = 'modules\02-prompt-to-pr.md'; title = 'Module 2 · Prompt to PR'; desc = 'Take-home self-study: drive a coding agent from prompt to merged PR end-to-end with Copilot Code Review and Agent Merge.' },
  @{ src = 'modules\03-slide-deck-maker.md'; dest = 'modules\03-slide-deck-maker.md'; title = 'Module 3 · Slide Deck Maker'; desc = 'Live deep-dive: generate a customer-ready deck with the GitHub App and Marp — pick from Customer Q&A, GitHub Docs summary, EBC deep-dive, or Pricing transition.' },
