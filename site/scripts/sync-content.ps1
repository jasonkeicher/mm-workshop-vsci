...
$files = @(
  @{ src = 'README.md'; dest = 'index.md'; title = 'Mid-Market Seller Copilot Workshop'; desc = 'A 90-minute hands-on workshop: GitHub App setup + Slide Deck Maker deep-dive, tied to the June 2026 usage-based billing transition. Five additional modules go home as self-study.' },
  ...
  @{ src = 'modules\02-slide-deck-maker.md'; dest = 'modules\02-slide-deck-maker.md'; title = 'Module 2 · Slide Deck Maker'; desc = 'Live deep-dive: generate a customer-ready deck with the GitHub App and Marp — pick from Customer Q&A, GitHub Docs summary, EBC deep-dive, or Pricing transition.' },
  @{ src = 'modules\03-prompt-to-pr.md'; dest = 'modules\03-prompt-to-pr.md'; title = 'Module 3 · Prompt to PR'; desc = 'Take-home self-study: drive a coding agent from prompt to merged PR end-to-end with Copilot Code Review and Agent Merge.' },
  @{ src = 'modules\04-vibe-code-game.md'; dest = 'modules\04-vibe-code-game.md'; title = 'Module 4 · Vibe-Code a Game'; desc = 'Take-home self-study: build a working browser game in under an hour with no manual code.' },
