...
$files = @(
  ...
  @{ src = 'modules\03-slide-deck-maker.md'; dest = 'modules\03-slide-deck-maker.md'; title = 'Module 3 · Slide Deck Maker'; desc = 'Generate a customer-ready deck from a prospect question using the GitHub App and Marp.' },
